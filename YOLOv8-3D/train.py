...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint('./' + select_model + '/' + select_model + '_weights.h5', monitor='val_loss',
                                 verbose=1, save_best_only=True)
    tensorboard = TensorBoard(log_dir='./' + select_model + '/logs/', histogram_freq=0, write_graph=True,
                              write_images=False)
